...
$language = array (
  ...
  'simplesaml:error:no_source' => 'Geen SAML connectie gedefinieerd',
  'simplesaml:error:source_not_enabled' => 'De opgegeven SAML connectie is niet ingeschakeld op deze site',
  'simplesaml:error:source_mismatch' => 'De opgegeven SAML connectie komt niet overeen met de server connectie',
  'simplesaml:error:class' => 'Fout tijdens het ophalen van de SAML configuratie: %s',
  'simplesaml:no_linked_account:title' => 'Geen account gekoppeld aan de SAML connectie: %s',
  'simplesaml:no_linked_account:description' => 'Er kon geen account worden gevonden dat is gekoppeld aan je SAML acount van %s. Je kunt je account van deze site koppelen door je hieronder aan te melden of te registreren.',
  ...
  'simplesaml:settings:sources:name' => 'SAML connectie',
  ...
  'simplesaml:usersettings:not_connected' => 'Je account is niet gekoppeld met de SAML connectie %s. Als je je wilt aanmelden op deze site met je SAML account, koppel dan aub beide accounts.',
  'simplesaml:usersettings:link_url' => 'Klik hier om beide accounts te koppelen',
  'simplesaml:usersettings:no_sources' => 'Er zijn geen SAML koppelingen beschikbaar, vraag de beheerder om dit te configureren.',
  'simplesaml:widget:description' => 'Toont een aanmeld widget met enkel de SAML koppelingen',
  'simplesaml:widget:select_source' => 'Selecteer de SAML connectie om te tonen in de widget',
  'simplesaml:widget:logged_in' => 'Welkom <b>%s</b> op de <b>%s</b> community',
  'simplesaml:login:no_linked_account' => 'Er is geen account gekoppeld aan de SAML connectie %s',
  'simplesaml:authorize:error:attributes' => 'Er konden geen attributen worden gevonden vanuit de SAML connectie %s, probeer het nogmaals of neem contact op met de site beheerder',
  'simplesaml:authorize:error:external_id' => 'Er kon geen unieke identificatie worden gevonden vanuit de SAML connectie %s, probeer het nogmaals of neem contact op met de site beheerder',
  'simplesaml:authorize:error:link' => 'Er is een onbekende fout opgetreden tijdens het koppelen met de SAML connectie %s',
